      ...
      <div className="container py-32">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="text-left animate-fade-in">
            ...
            >
              Discover your true potential and create lasting positive change
              with guided support tailored to your unique journey
            </p>
            <div
          ...
          <div
            className="relative animate-fade-in order-first md:order-last"
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-8 z-20">
                <p className="text-white text-lg md:text-xl italic text-center">
                  "Like flowers, we are meant to bloom in our own time—gently,
