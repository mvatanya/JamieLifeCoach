...
const testimonials: TestimonialProps[] = [
  {
    quote: "Working with this coach transformed my approach to life's challenges. The personalized strategies and ongoing support helped me achieve balance I never thought possible.",
    name: "Sarah Johnson",
  ...
  {
    quote: "After struggling with career decisions for years, the 90-day coaching program gave me clarity and confidence. I now have a roadmap for success that aligns with my true values.",
  ...
  {
    quote: "The coaching sessions helped me break through limiting beliefs that were holding me back for years. I'm now pursuing goals I previously thought were impossible.",
      ...
      <div className="container">
        <div className="max-w-3xl mx-auto text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg text-gray-700">
            Hear from people who have experienced the transformative power of our coaching programs.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative bg-primaryBg rounded-2xl p-8 md:p-12 shadow-soft animate-fade-in">
            ...
            <p className="text-lg md:text-xl italic mb-8">"{currentTestimonial.quote}"</p>
